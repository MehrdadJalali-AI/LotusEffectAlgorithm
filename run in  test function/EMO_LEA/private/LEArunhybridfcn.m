function [xOpt,fval] = LEArunhybridfcn(fitnessfcn,xOpt,...
    Aineq,bineq,Aeq,beq,LB,UB,nonlcon,options)
% Calls the hybrid function defined in options.HybridFcn, from LEA.
...
elseif strcmp(func2str(HybridFcn),func2str(@fminunc)) || ...
    ...
    warning('LEA:hybridfcn:unrecognized',...
